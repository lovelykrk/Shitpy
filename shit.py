...
TOKEN = '7991279504:AAFSf6ZvqzljwJk1z77DqPVq63OzmCE-x1Y'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [7043604316]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @An_oldschoolguy")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @An_oldschoolguy\n"
...
def show_id(message):
    ...
    bot_owner = "@An_oldschoolguy"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @An_oldschoolguy")
...
This bot is owned and operated by @An_oldschoolguy on Telegram and all4outgaming on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @An_oldschoolguy on Telegram and An_oldschoolguy, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @An_oldschoolguy on Telegram and all4outgaming on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
* **🔄 MODIFICATION AND DISCONTINUATION**: You agree that @An_oldschoolguy on Telegram may modify or discontinue this bot at any time, without notice, and that you will not be entitled to any compensation or reimbursement for any losses or damages arising from such modification or discontinuation.
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @An_oldschoolguy Script and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
